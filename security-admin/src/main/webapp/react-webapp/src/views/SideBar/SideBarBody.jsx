              ...
              <React.Fragment>
                <li className="list-group-item">
                  <NavLink
                    ...
                    onClick={() => {
                      props.closeCollapse();
                      console.log("/reports/audit/bigData");
                    }}
                ...
                <li className="list-group-item">
                  <NavLink
                    ...
                    onClick={() => {
                      props.closeCollapse();
                      console.log("/reports/audit/admin");
                    }}
                    className="list-group-item"
                  >
                    Admin
                ...
                <li className="list-group-item">
                  <NavLink
                    ...
                    onClick={() => {
                      props.closeCollapse();
                      console.log("/reports/audit/loginSession");
                    }}
                    className="list-group-item"
                  >
                    Login Sessions
                ...
                <li className="list-group-item">
                  <NavLink
                    ...
                    onClick={() => {
                      props.closeCollapse();
                      console.log("/reports/audit/agent");
                    }}
                    className="list-group-item"
                  >
                    Plugins
                ...
                <li className="list-group-item">
                  <NavLink
                    ...
                    onClick={() => {
                      props.closeCollapse();
                      console.log("/reports/audit/pluginStatus");
                    }}
                    className="list-group-item"
                  >
                    Plugin Status
                ...
                <li className="list-group-item">
                  <NavLink
                    ...
                    onClick={() => {
                      props.closeCollapse();
                      console.log("/reports/audit/userSync");
                    }}
                    className="list-group-item"
                  >
                    User Sync
            ...
            {(isAuditor() || isSystemAdmin()) && (
              <li className="list-group-item">
                <NavLink
                  ...
                  onClick={() => {
                    props.closeCollapse();
                    console.log("/permissions/models");
                  }}
                  className="list-group-item"
                >
                  Permission
