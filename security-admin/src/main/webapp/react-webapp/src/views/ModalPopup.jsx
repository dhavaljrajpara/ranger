...
class ModalPopup extends Component {
    ...
    export = async () => {
        ...
        try {
            ...
            const exportResp = await (
                axios.get('/plugins/policies/exportJson', {
                    params: {
            ...
            <>
                <Modal show={this.props.show} onHide={this.Close} size="lg">
                    ...
                    <Modal.Body>
                        ...
                        <b><h6 className="servicename">Service Type*</h6></b>
                        <Select
                        ...
                        <b><h6 className="servicename">Select Service Name*</h6></b>
                        <Select
